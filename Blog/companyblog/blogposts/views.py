...
from companyblog.users.picture_handler import add_featured_img
...
def create_post():
    ...
    if form.validate_on_submit():
        blog_post = BlogPost(title=form.heading.data,
                             ...
                             pic=add_featured_img(form.picture.data)
                             )
...
def blog_post(blog_post_id):
    ...
    return render_template('blog_post.html', title=blog_post.title,
                           ...
                           meta_desc=blog_post.meta_desc, category=blog_post.category, picture=blog_post.pic
                           )
